...
def get_data_size_from_execution_mode(debugging: bool = False) -> bool:
    ...
    purpose. See e.g. get_cleaned_pump_data in argue/data/SSV/utils.py, which needs to know the size of
    the dataset.
...
#     argue/data/SSV for the presence of a .csv file containing already cleaned data.
#
...
#     :return: boolean indicating if local cleaned data exists in the argue/data/SSV folder or not
#     """
