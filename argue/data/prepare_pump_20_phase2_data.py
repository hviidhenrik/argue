...
if __name__ == "__main__":
    ...
    df = df.loc["2019-09-07": "2019-11-15"]
    ...
    plt.plot(df[f"effect_pump_20_MW"], 18 * df[f"effect_pump_20_MW"] + 3)
    plt.show()
    ...
    df_both_active = filter_points_beyond_linear_cut(df_both_active, x_col=f"effect_pump_{PUMP_NUMBER}_MW",
                                                     y_col="flow_after_pump", slope=18, intercept=60,
    ...
    df_final.loc["2019-11-06 11:00:00":"2019-11-07 00:33:00", "faulty"] = 1
    save_local_data(df_final, filename=path / "data_pump20_phase2.csv", index="timelocal")
