...
def extract_activations(
    network: tf.keras.models.Model, target_name: str, keep_output_layer: bool = False
    ...
    :param keep_output_layer: whether to keep the final layer activations (the output of the network) or not
...
class Network:
    ...
    @staticmethod
    def _init_weight_regularizer(l1_weight_penalty, l2_weight_penalty):
...
if __name__ == "__main__":
    ...
    FFN = Network(name="ffn").build_model(
