"""This script defines the cooling water pump 20 at SKV3"""
...
class CoolPumpModel_20(CoolPumpBaseModel):
    """
        this Class performs predictive maintenance on coolwater pump 20 at SKV
    """
    ...
    def __init__(
        ...
        """
        self.tags = (
            "SKV_03_PAC20FU650_XQ01.PV",
            "SKV_03_PAC10FU650_XQ01.PV",  # pump 10
            "SKV_03_PAC20FU650_XQ02.PV",
            "SKV_03_PAC20GU001D_XQ01.PV",
            "SKV_03_PAC10GU001D_XQ01.PV",  # pump 10
            # "SKV_03_PAC20FU650_XQ03.PV"
        )

        self.rename = {
            "SKV_03_PAC20FU650_XQ01.PV": "motor_effect",
            "SKV_03_PAC10FU650_XQ01.PV": "motor_effect_other",  # pump 10
            "SKV_03_PAC20FU650_XQ02.PV": "kv_flow",
            "SKV_03_PAC20GU001D_XQ01.PV": "pump_rotation",
            "SKV_03_PAC10GU001D_XQ01.PV": "pump_rotation_other",  # pump 10
            # "SKV_03_PAC20FU650_XQ03.PV": "hydraulic_effect"
        }
        self.model_description = """Model object for SKV3 cooling pump 20.
...
if __name__ == "__main__":
    ...
    predict_period = time_interval("2020-02-10 00:00:00", "2020-10-14 10:00:00")
    ...
    # df_raw = pump_model.get_local_test_data(train=True, large_dataset=True)
