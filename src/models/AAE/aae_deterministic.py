...
x_train, x_test = train_test_split(df_features, test_size=0.1)
...
# -------------------------------------------------------------------------------------------------------------
# Create models
image_size = df_features.shape[1]
h_dim = 18
z_dim = 2
...
for epoch in range(n_epochs):
    ...
    for batch_number, (batch_x) in enumerate(train_dataset):
        # -------------------------------------------------------------------------------------------------------------
    ...
    print('Epoch {:4d}: TIME: {:.2f} secs ETA: {:.0f} secs AE_LOSS: {:.4f} DC_LOSS: {:.4f} DC_ACC: {:.4f} GEN_LOSS: {:.4f}' \
