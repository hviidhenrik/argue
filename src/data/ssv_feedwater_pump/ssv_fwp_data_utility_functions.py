...
def get_data_size_from_execution_mode(debugging: bool = False) -> bool:
    ...
    purpose. See e.g. get_cleaned_pump_data in src/data/SSV/data_utils.py, which needs to know the size of
    the dataset.
...
def get_clean_figures_path(pump_number: Union[str, int]) -> Path:
    ...
    return get_ARGUE_cleaning_figures_path() / f"ssv_fwp_{pump_number}"
